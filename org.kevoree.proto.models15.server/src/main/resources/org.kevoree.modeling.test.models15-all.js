...
(function (org) {
    ...
    (function (kevoree) {
        ...
        (function (test) {
            var models15;
            (function (models15) {
                var SmartGridModel = (function (_super) {
                    __extends(SmartGridModel, _super);
                    function SmartGridModel() {
                        _super.call(this);
                        this._metaModel = new org.kevoree.modeling.api.abs.AbstractMetaModel("SmartGrid", -1);
                        var tempMetaClasses = new Array();
                        tempMetaClasses[1] = org.kevoree.test.models15.meta.MetaSmartMeter.getInstance();
                        tempMetaClasses[0] = org.kevoree.test.models15.meta.MetaSmartGrid.getInstance();
                        tempMetaClasses[2] = org.kevoree.test.models15.meta.MetaConcentrator.getInstance();
                        this._metaModel.init(tempMetaClasses);
                    }
                    SmartGridModel.prototype.internal_create = function (key) {
                        return new org.kevoree.test.models15.SmartGridUniverse(this, key);
                    };
                    SmartGridModel.prototype.metaModel = function () {
                        return this._metaModel;
                    };
                    return SmartGridModel;
                })(org.kevoree.modeling.api.abs.AbstractKModel);
                models15.SmartGridModel = SmartGridModel;
                var SmartGridUniverse = (function (_super) {
                    __extends(SmartGridUniverse, _super);
                    function SmartGridUniverse(p_model, key) {
                        _super.call(this, p_model, key);
                    }
                    SmartGridUniverse.prototype.internal_create = function (timePoint) {
                        return new org.kevoree.test.models15.impl.SmartGridViewImpl(timePoint, this);
                    };
                    return SmartGridUniverse;
                })(org.kevoree.modeling.api.abs.AbstractKUniverse);
                models15.SmartGridUniverse = SmartGridUniverse;
                var impl;
                (function (impl) {
                    var ConcentratorImpl = (function (_super) {
                        __extends(ConcentratorImpl, _super);
                        function ConcentratorImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        ConcentratorImpl.prototype.addMeters = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kevoree.test.models15.meta.MetaConcentrator.REF_METERS, p_obj);
                            return this;
                        };
                        ConcentratorImpl.prototype.removeMeters = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kevoree.test.models15.meta.MetaConcentrator.REF_METERS, p_obj);
                            return this;
                        };
                        ConcentratorImpl.prototype.getMeters = function () {
                            var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                            this.internal_ref(org.kevoree.test.models15.meta.MetaConcentrator.REF_METERS, function (kObjects) {
                        ...
                        ConcentratorImpl.prototype.sizeOfMeters = function () {
                            return this.size(org.kevoree.test.models15.meta.MetaConcentrator.REF_METERS);
                        };
                        ConcentratorImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                        return ConcentratorImpl;
                    })(org.kevoree.modeling.api.abs.AbstractKObject);
                    impl.ConcentratorImpl = ConcentratorImpl;
                    var SmartGridImpl = (function (_super) {
                        __extends(SmartGridImpl, _super);
                        function SmartGridImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        SmartGridImpl.prototype.addConcentrators = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kevoree.test.models15.meta.MetaSmartGrid.REF_CONCENTRATORS, p_obj);
                            return this;
                        };
                        SmartGridImpl.prototype.removeConcentrators = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kevoree.test.models15.meta.MetaSmartGrid.REF_CONCENTRATORS, p_obj);
                            return this;
                        };
                        SmartGridImpl.prototype.getConcentrators = function () {
                            var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                            this.internal_ref(org.kevoree.test.models15.meta.MetaSmartGrid.REF_CONCENTRATORS, function (kObjects) {
                                var casted = new Array();
                                for (var i = 0; i < kObjects.length; i++) {
                                    casted[i] = kObjects[i];
                                }
                        ...
                        SmartGridImpl.prototype.sizeOfConcentrators = function () {
                            return this.size(org.kevoree.test.models15.meta.MetaSmartGrid.REF_CONCENTRATORS);
                        };
                        SmartGridImpl.prototype.addMeters = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kevoree.test.models15.meta.MetaSmartGrid.REF_METERS, p_obj);
                            return this;
                        };
                        SmartGridImpl.prototype.removeMeters = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kevoree.test.models15.meta.MetaSmartGrid.REF_METERS, p_obj);
                            return this;
                        };
                        SmartGridImpl.prototype.getMeters = function () {
                            var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                            this.internal_ref(org.kevoree.test.models15.meta.MetaSmartGrid.REF_METERS, function (kObjects) {
                                var casted = new Array();
                                for (var i = 0; i < kObjects.length; i++) {
                                    casted[i] = kObjects[i];
                                }
                        ...
                        SmartGridImpl.prototype.sizeOfMeters = function () {
                            return this.size(org.kevoree.test.models15.meta.MetaSmartGrid.REF_METERS);
                        };
                        SmartGridImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                        return SmartGridImpl;
                    })(org.kevoree.modeling.api.abs.AbstractKObject);
                    impl.SmartGridImpl = SmartGridImpl;
                    var SmartGridViewImpl = (function (_super) {
                        __extends(SmartGridViewImpl, _super);
                        function SmartGridViewImpl(p_now, p_universe) {
                            _super.call(this, p_now, p_universe);
                        }
                        SmartGridViewImpl.prototype.internalCreate = function (p_clazz, p_key) {
                            if (p_clazz == null) {
                                return null;
                            }
                            switch (p_clazz.index()) {
                                case 1:
                                    return new org.kevoree.test.models15.impl.SmartMeterImpl(this, p_key, p_clazz);
                                case 0:
                                    return new org.kevoree.test.models15.impl.SmartGridImpl(this, p_key, p_clazz);
                                case 2:
                                    return new org.kevoree.test.models15.impl.ConcentratorImpl(this, p_key, p_clazz);
                                default:
                                    return new org.kevoree.modeling.api.reflexive.DynamicKObject(this, p_key, p_clazz);
                            }
                        };
                        SmartGridViewImpl.prototype.createSmartMeter = function () {
                            return this.create(org.kevoree.test.models15.meta.MetaSmartMeter.getInstance());
                        };
                        SmartGridViewImpl.prototype.createSmartGrid = function () {
                            return this.create(org.kevoree.test.models15.meta.MetaSmartGrid.getInstance());
                        };
                        SmartGridViewImpl.prototype.createConcentrator = function () {
                            return this.create(org.kevoree.test.models15.meta.MetaConcentrator.getInstance());
                        };
                        SmartGridViewImpl.prototype.universe = function () {
                            return _super.prototype.universe.call(this);
                        };
                        return SmartGridViewImpl;
                    })(org.kevoree.modeling.api.abs.AbstractKView);
                    impl.SmartGridViewImpl = SmartGridViewImpl;
                    var SmartMeterImpl = (function (_super) {
                        __extends(SmartMeterImpl, _super);
                        function SmartMeterImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        SmartMeterImpl.prototype.getConsumption = function () {
                            return this.get(org.kevoree.test.models15.meta.MetaSmartMeter.ATT_CONSUMPTION);
                        };
                        SmartMeterImpl.prototype.setConsumption = function (p_obj) {
                            this.set(org.kevoree.test.models15.meta.MetaSmartMeter.ATT_CONSUMPTION, p_obj);
                            return this;
                        };
                        SmartMeterImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                        return SmartMeterImpl;
                    })(org.kevoree.modeling.api.abs.AbstractKObject);
                    impl.SmartMeterImpl = SmartMeterImpl;
                })(impl = models15.impl || (models15.impl = {}));
                var meta;
                (function (meta) {
                    var MetaConcentrator = (function (_super) {
                        __extends(MetaConcentrator, _super);
                        function MetaConcentrator() {
                            _super.call(this, "org.kevoree.test.models15.Concentrator", 2);
                            var temp_all = new Array();
                            var temp_references = new Array();
                            temp_all[0] = MetaConcentrator.REF_METERS;
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaConcentrator.getInstance = function () {
                            if (MetaConcentrator.INSTANCE == null) {
                                MetaConcentrator.INSTANCE = new org.kevoree.test.models15.meta.MetaConcentrator();
                            }
                            return MetaConcentrator.INSTANCE;
                        };
                        MetaConcentrator.INSTANCE = null;
                        MetaConcentrator.REF_METERS = new org.kevoree.modeling.api.abs.AbstractMetaReference("meters", 4, false, false, function () {
                            return org.kevoree.test.models15.meta.MetaSmartMeter.getInstance();
                        }, null, function () {
                            return org.kevoree.test.models15.meta.MetaConcentrator.getInstance();
                        });
                        return MetaConcentrator;
                    })(org.kevoree.modeling.api.abs.AbstractMetaClass);
                    meta.MetaConcentrator = MetaConcentrator;
                    var MetaSmartGrid = (function (_super) {
                        __extends(MetaSmartGrid, _super);
                        function MetaSmartGrid() {
                            _super.call(this, "org.kevoree.test.models15.SmartGrid", 0);
                            var temp_all = new Array();
                            var temp_references = new Array();
                            temp_all[0] = MetaSmartGrid.REF_CONCENTRATORS;
                            temp_all[1] = MetaSmartGrid.REF_METERS;
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaSmartGrid.getInstance = function () {
                            if (MetaSmartGrid.INSTANCE == null) {
                                MetaSmartGrid.INSTANCE = new org.kevoree.test.models15.meta.MetaSmartGrid();
                            }
                            return MetaSmartGrid.INSTANCE;
                        };
                        MetaSmartGrid.INSTANCE = null;
                        MetaSmartGrid.REF_CONCENTRATORS = new org.kevoree.modeling.api.abs.AbstractMetaReference("concentrators", 4, true, false, function () {
                            return org.kevoree.test.models15.meta.MetaConcentrator.getInstance();
                        }, null, function () {
                            return org.kevoree.test.models15.meta.MetaSmartGrid.getInstance();
                        });
                        MetaSmartGrid.REF_METERS = new org.kevoree.modeling.api.abs.AbstractMetaReference("meters", 5, true, false, function () {
                            return org.kevoree.test.models15.meta.MetaSmartMeter.getInstance();
                        }, null, function () {
                            return org.kevoree.test.models15.meta.MetaSmartGrid.getInstance();
                        });
                        return MetaSmartGrid;
                    })(org.kevoree.modeling.api.abs.AbstractMetaClass);
                    meta.MetaSmartGrid = MetaSmartGrid;
                    var MetaSmartMeter = (function (_super) {
                        __extends(MetaSmartMeter, _super);
                        function MetaSmartMeter() {
                            _super.call(this, "org.kevoree.test.models15.SmartMeter", 1);
                            var temp_all = new Array();
                            temp_all[0] = MetaSmartMeter.ATT_CONSUMPTION;
                            var temp_references = new Array();
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaSmartMeter.getInstance = function () {
                            if (MetaSmartMeter.INSTANCE == null) {
                                MetaSmartMeter.INSTANCE = new org.kevoree.test.models15.meta.MetaSmartMeter();
                            }
                            return MetaSmartMeter.INSTANCE;
                        };
                        MetaSmartMeter.INSTANCE = null;
                        MetaSmartMeter.ATT_CONSUMPTION = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("consumption", 4, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.INT, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                        return MetaSmartMeter;
                    })(org.kevoree.modeling.api.abs.AbstractMetaClass);
                    meta.MetaSmartMeter = MetaSmartMeter;
                })(meta = models15.meta || (models15.meta = {}));
            })(models15 = test.models15 || (test.models15 = {}));
        })(test = kevoree.test || (kevoree.test = {}));
    })(kevoree = org.kevoree || (org.kevoree = {}));
})(org || (org = {}));
